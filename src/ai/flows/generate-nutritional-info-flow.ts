...
'use server';
/**
 * @fileOverview Generates detailed nutritional information for selected recipes.
 *
...
const NutritionalDetailSchema = z.object({
  calories: z.string().describe('Estimated total calories for the dish (for 4 people). Example: "550 kcal"'),
  protein: z.string().describe('Estimated total protein in grams for the dish (for 4 people). Example: "30g"'),
  carbohydrates: z.string().describe('Estimated total carbohydrates in grams for the dish (for 4 people). Example: "45g"'),
  fats: z.string().describe('Estimated total fats in grams for the dish (for 4 people). Example: "20g"'),
...
Cada receta está calculada para 4 personas, por lo que la información nutricional debe reflejar el total para las 4 porciones (es decir, el plato completo).
...
- nutritionalInfo: Un objeto con:
  - calories: Calorías totales estimadas para el plato completo (4 personas). Ejemplo: "600 kcal".
  - protein: Gramos de proteína totales estimados para el plato completo (4 personas). Ejemplo: "40g".
  - carbohydrates: Gramos de carbohidratos totales estimados para el plato completo (4 personas). Ejemplo: "55g".
  - fats: Gramos de grasas totales estimados para el plato completo (4 personas). Ejemplo: "25g".
