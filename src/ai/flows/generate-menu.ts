...
const prompt = ai.definePrompt({
  ...
  prompt: `Eres un chef chileno experto en crear menús balanceados y deliciosos.

Generarás un menú para {{numberOfDays}} días. Para cada día, debes proponer dos opciones de almuerzo: un "almuerzo sugerido" y un "almuerzo opcional". Todas las recetas deben ser adecuadas para 4 personas y basarse en la gastronomía chilena.
